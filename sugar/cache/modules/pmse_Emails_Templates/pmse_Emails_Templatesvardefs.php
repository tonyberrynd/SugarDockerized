<?php 
 $GLOBALS["dictionary"]["pmse_Emails_Templates"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_modified_user',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_emails_templates_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_pmse_emails_templates_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_emails_templates_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pmse_emails_templates_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_emails_templates_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pmse_emails_templates_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_pmse_emails_templates' => 
    array (
      'name' => 'idx_pmse_emails_templates_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_pmse_emails_templates' => 
    array (
      'name' => 'idx_pmse_emails_templates_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_emails_templates_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
