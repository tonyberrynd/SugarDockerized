<?php 
 $GLOBALS["dictionary"]["KBContentTemplate"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_modified_user',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'kbcontenttemplates_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'kbcontenttemplates_teams',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_kbcontenttemplates_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_kbcontent_templates_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_kbcontent_templates_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_kbcontent_templates_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_kbcontent_templates_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_kbcontent_templates' => 
    array (
      'name' => 'idx_kbcontent_templates_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_kbcontent_templates' => 
    array (
      'name' => 'idx_kbcontent_templates_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
