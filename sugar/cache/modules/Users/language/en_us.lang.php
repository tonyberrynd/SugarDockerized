...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to your Sugar calendar within iCal-supported applications. Sugar calendar events are viewable as read-only in external calendar applications and any edits to events (e.g. meetings, calls etc.) can only be made in Sugar.',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
  ...
  'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_ADMIN_USER' => 'Please access <a href="%s" target="_blank">Cloud Settings</a> to make changes to read-only fields.',
  'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_REGULAR_USER' => 'Please contact your Sugar administrator if you would like to make changes to read-only fields.',
);