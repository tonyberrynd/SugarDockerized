 ...
 $GLOBALS["dictionary"]["KBDocument"]=array (
  ...
  array (
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'kbdocument_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'kbdocuments_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'kbdocuments_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'kbdocuments_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_kbdocuments_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_kbdocuments_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'acl_team_set_kbdocuments' => 
    array (
      'name' => 'idx_kbdocuments_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_kbdocuments_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
