<?php 
 $GLOBALS["dictionary"]["ReportSchedule"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reportschedules_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reportschedules_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'reportschedule_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'reportschedules_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'reportschedules_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'relationship' => 'reportschedules_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reportschedules_assigned_user',
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'reportschedules_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reportschedules_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'reportschedules_teams',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_report_schedules_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_report_schedules_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_report_schedules_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_report_schedules_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_report_schedules_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'team_set_report_schedules' => 
    array (
      'name' => 'idx_report_schedules_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_report_schedules' => 
    array (
      'name' => 'idx_report_schedules_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
