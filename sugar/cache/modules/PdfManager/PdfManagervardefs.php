 ...
 $GLOBALS["dictionary"]["PdfManager"]=array (
  ...
  array (
    ...
    array (
      ...
      'relationship' => 'pdfmanager_locked_fields',
      'source' => 'non-db',
      'exportable' => false,
      'duplicate_merge' => 'disabled',
    ),
  ...
  array (
    ...
    'acl_team_set_pdfmanager' => 
    array (
      'name' => 'idx_pdfmanager_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pdfmanager_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
