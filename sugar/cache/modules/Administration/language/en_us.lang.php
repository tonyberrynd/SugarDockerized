...
',
  ...
  'LBL_MAILBOX_DESC' => 'Configure the IMAP account Sugar uses to receive system emails (i.e. group inboxes including automatic case creation and campaign bounce handling).',
  ...
  'LBL_MASS_EMAIL_CONFIG_DESC' => 'Configure the email account Sugar uses to send system emails (e.g. notifications, campaigns, scheduled reports etc.), email options for the organization and email security.',
...
',
  ...
  'WARN_LICENSE_SEATS3' => '. <p class="error">Please deactivate some users, contact your partner or sales representative, or email <a href=\'mailto:sales@sugarcrm.com\'>sales@sugarcrm.com</a>.</p><p class="error">For more information, see the <a target="_blank" href="https://support.sugarcrm.com/Knowledge_Base/License/User_Types_and_Sugar_Licenses/index.html">Understanding User Types and Sugar Licenses</a> article.</p>',
...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_PMSE_ADMIN_DESC_ENGINELOGS_1' => 'Access the ',
