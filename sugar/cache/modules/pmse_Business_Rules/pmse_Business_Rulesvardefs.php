<?php 
 $GLOBALS["dictionary"]["pmse_Business_Rules"]=array (
  ...
  array (
    ...
    'name_del' => 
    array (
      'name' => 'idx_pmse_business_rules_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'acl_team_set_pmse_business_rules' => 
    array (
      'name' => 'idx_pmse_business_rules_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_business_rules_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
