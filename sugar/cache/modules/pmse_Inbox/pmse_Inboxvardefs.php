<?php 
 $GLOBALS["dictionary"]["pmse_Inbox"]=array (
  'table' => 'pmse_inbox',
  'audited' => false,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_inbox_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_inbox_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pmse_inbox_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pmse_inbox_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pmse_inbox_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_inbox_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_inbox_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_inbox_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_inbox_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'acl_team_set_pmse_inbox' => 
    array (
      'name' => 'idx_pmse_inbox_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_inbox_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
