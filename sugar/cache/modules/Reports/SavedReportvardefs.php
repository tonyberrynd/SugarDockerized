 ...
 $GLOBALS["dictionary"]["SavedReport"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reports_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reports_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'savedreport_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'reports_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_saved_reports_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_saved_reports_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_saved_reports_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_saved_reports_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
    ...
    'acl_team_set_saved_reports' => 
    array (
      'name' => 'idx_saved_reports_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
