<?php 
 $GLOBALS["dictionary"]["pmse_BpmRelatedDependency"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmrelateddependency_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_pmse_bpmrelateddependency_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_bpm_related_dependency_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pmse_bpm_related_dependency_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_bpm_related_dependency_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pmse_bpm_related_dependency_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_bpm_related_dependency_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
