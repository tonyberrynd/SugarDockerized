<?php 
 $GLOBALS["dictionary"]["pmse_BpmnActivity"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_activities',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmnactivity_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_bpmn_activity_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pmse_bpmn_activity_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_bpmn_activity_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pmse_bpmn_activity_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_bpmn_activity_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
