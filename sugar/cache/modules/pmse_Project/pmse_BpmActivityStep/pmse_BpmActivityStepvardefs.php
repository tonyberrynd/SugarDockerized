<?php 
 $GLOBALS["dictionary"]["pmse_BpmActivityStep"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmactivitystep_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmactivitystep_modified_user',
    ...
    array (
      'name' => 'activities',
      'type' => 'link',
      'relationship' => 'pmse_bpmactivitystep_activities',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_bpmactivitystep_assigned_user',
  ...
  array (
    'id' => 
    array (
      'name' => 'idx_pmse_bpmactivitystep_pk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_bpm_activity_step_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'deleted' => 
    array (
      'name' => 'idx_pmse_bpm_activity_step_id_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'id',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_bpm_activity_step_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
