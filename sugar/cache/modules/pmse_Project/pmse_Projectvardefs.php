<?php 
 $GLOBALS["dictionary"]["pmse_Project"]=array (
  'table' => 'pmse_project',
  'audited' => false,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_project_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_project_modified_user',
    ...
    array (
      'name' => 'following_link',
      'type' => 'link',
      'relationship' => 'pmse_project_following',
      'source' => 'non-db',
      'vname' => 'LBL_FOLLOWING',
      'reportable' => false,
    ),
    ...
    array (
      'name' => 'favorite_link',
      'type' => 'link',
      'relationship' => 'pmse_project_favorite',
      'source' => 'non-db',
      'vname' => 'LBL_FAVORITE',
      'reportable' => false,
      'workflow' => false,
    ...
    array (
      'name' => 'team_link',
      'type' => 'link',
      'relationship' => 'pmse_project_team',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_project_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'pmse_project_teams',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'pmse_project_assigned_user',
  ...
  array (
    ...
    'date_modified' => 
    array (
      'name' => 'idx_pmse_project_date_modfied',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_modified',
    ...
    'date_entered' => 
    array (
      'name' => 'idx_pmse_project_date_entered',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'date_entered',
    ...
    'name_del' => 
    array (
      'name' => 'idx_pmse_project_name_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'name',
    ...
    'team_set_pmse_project' => 
    array (
      'name' => 'idx_pmse_project_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'team_set_id',
    ...
    'acl_team_set_pmse_project' => 
    array (
      'name' => 'idx_pmse_project_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
    ...
    'assigned_user_id' => 
    array (
      'name' => 'idx_pmse_project_assigned_del',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'assigned_user_id',
