 ...
 $GLOBALS["dictionary"]["SavedSearch"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'savedsearch_team_count_relationship',
      'link_type' => 'one',
      'module' => 'Teams',
      'bean_name' => 'TeamSet',
      'source' => 'non-db',
    ...
    array (
      'name' => 'teams',
      'type' => 'link',
      'relationship' => 'savedsearch_teams',
  ...
  array (
    ...
    'acl_team_set_saved_search' => 
    array (
      'name' => 'idx_saved_search_acl_tmst_id',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'acl_team_set_id',
