...
return this;};Label.prototype.setMessage=function(newMessage){this.message=newMessage;if(this.text){this.text.innerHTML=this.message;}
...
/* End of File include/javascript/pmse/lib/jcore.js */
