 ...
 */
SUGAR.FunctionMap = {
	'createList'	:	SUGAR.expressions.DefineEnumExpression,	'enum'	:	SUGAR.expressions.DefineEnumExpression,	'getDropdownValueSet'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getTransDD'	:	SUGAR.expressions.SugarTranslatedDropDownExpression,	'getListWhere'	:	SUGAR.expressions.SugarListWhereExpression,	'forecastSalesStages'	:	SUGAR.expressions.ForecastSalesStageExpression,	'forecastIncludedCommitStages'	:	SUGAR.expressions.ForecastIncludedCommitStagesExpression,	'getDropdownKeySet'	:	SUGAR.expressions.SugarDropDownExpression,	'getDD'	:	SUGAR.expressions.SugarDropDownExpression,	'rollupConditionalSum'	:	SUGAR.expressions.SumConditionalRelatedExpression,	'rollupSum'	:	SUGAR.expressions.SumRelatedExpression,	'rollupCurrencySum'	:	SUGAR.expressions.SumRelatedExpression,	'add'	:	SUGAR.expressions.AddExpression,	'currencyAdd'	:	SUGAR.expressions.AddExpression,	'ceil'	:	SUGAR.expressions.CeilingExpression,	'ceiling'	:	SUGAR.expressions.CeilingExpression,	'number'	:	SUGAR.expressions.ValueOfExpression,	'floor'	:	SUGAR.expressions.FloorExpression,	'countConditional'	:	SUGAR.expressions.CountConditionalRelatedExpression,	'rollupMin'	:	SUGAR.expressions.MinRelatedExpression,	'round'	:	SUGAR.expressions.RoundExpression,	'stddev'	:	SUGAR.expressions.StandardDeviationExpression,	'min'	:	SUGAR.expressions.MinimumExpression,	'rollupAve'	:	SUGAR.expressions.AverageRelatedExpression,	'rollupAvg'	:	SUGAR.expressions.AverageRelatedExpression,	'strlen'	:	SUGAR.expressions.StringLengthExpression,	'max'	:	SUGAR.expressions.MaximumExpression,	'negate'	:	SUGAR.expressions.NegateExpression,	'average'	:	SUGAR.expressions.AverageExpression,	'avg'	:	SUGAR.expressions.AverageExpression,	'divide'	:	SUGAR.expressions.DivideExpression,	'currencyDivide'	:	SUGAR.expressions.DivideExpression,	'div'	:	SUGAR.expressions.DivideExpression,	'abs'	:	SUGAR.expressions.AbsoluteValueExpression,	'subtract'	:	SUGAR.expressions.SubtractExpression,	'currencySubtract'	:	SUGAR.expressions.SubtractExpression,	'sub'	:	SUGAR.expressions.SubtractExpression,	'pow'	:	SUGAR.expressions.PowerExpression,	'indexOf'	:	SUGAR.expressions.IndexOfExpression,	'ln'	:	SUGAR.expressions.NaturalLogExpression,	'log'	:	SUGAR.expressions.LogExpression,	'count'	:	SUGAR.expressions.CountRelatedExpression,	'multiply'	:	SUGAR.expressions.MultiplyExpression,	'currencyMultiply'	:	SUGAR.expressions.MultiplyExpression,	'mul'	:	SUGAR.expressions.MultiplyExpression,	'median'	:	SUGAR.expressions.MedianExpression,	'rollupMax'	:	SUGAR.expressions.MaxRelatedExpression,	'time'	:	SUGAR.expressions.DefineTimeExpression,	'hourOfDay'	:	SUGAR.expressions.HourOfDayExpression,	'ifElse'	:	SUGAR.expressions.ConditionExpression,	'cond'	:	SUGAR.expressions.ConditionExpression,	'valueAt'	:	SUGAR.expressions.IndexValueExpression,	'related'	:	SUGAR.expressions.RelatedFieldExpression,	'sugarField'	:	SUGAR.expressions.SugarFieldExpression,	'currencyRate'	:	SUGAR.expressions.CurrencyRateExpression,	'greaterThan'	:	SUGAR.expressions.GreaterThanExpression,	'isForecastClosedLost'	:	SUGAR.expressions.IsForecastClosedLostExpression,	'isBefore'	:	SUGAR.expressions.isBeforeExpression,	'isValidEmail'	:	SUGAR.expressions.IsValidEmailExpression,	'isAlphaNumeric'	:	SUGAR.expressions.IsAlphaNumericExpression,	'not'	:	SUGAR.expressions.NotExpression,	'equal'	:	SUGAR.expressions.EqualExpression,	'isValidDBName'	:	SUGAR.expressions.IsValidDBNameExpression,	'doBothExist'	:	SUGAR.expressions.BinaryDependencyExpression,	'isWithinRange'	:	SUGAR.expressions.IsInRangeExpression,	'isValidPhone'	:	SUGAR.expressions.IsValidPhoneExpression,	'isForecastClosed'	:	SUGAR.expressions.IsForecastClosedExpression,	'isRequiredCollection'	:	SUGAR.expressions.IsRequiredCollectionExpression,	'isForecastClosedWon'	:	SUGAR.expressions.IsForecastClosedWonExpression,	'isInList'	:	SUGAR.expressions.IsInEnumExpression,	'isInEnum'	:	SUGAR.expressions.IsInEnumExpression,	'or'	:	SUGAR.expressions.OrExpression,	'and'	:	SUGAR.expressions.AndExpression,	'isValidTime'	:	SUGAR.expressions.IsValidTimeExpression,	'isValidDate'	:	SUGAR.expressions.IsValidDateExpression,	'isNumeric'	:	SUGAR.expressions.IsNumericExpression,	'isAlpha'	:	SUGAR.expressions.IsAlphaExpression,	'isAfter'	:	SUGAR.expressions.isAfterExpression,	'dayofweek'	:	SUGAR.expressions.DayOfWeekExpression,	'maxRelatedDate'	:	SUGAR.expressions.MaxRelatedDateExpression,	'date'	:	SUGAR.expressions.DefineDateExpression,	'addDays'	:	SUGAR.expressions.AddDaysExpression,	'today'	:	SUGAR.expressions.TodayExpression,	'hoursUntil'	:	SUGAR.expressions.HoursUntilExpression,	'daysUntil'	:	SUGAR.expressions.DaysUntilExpression,	'monthofyear'	:	SUGAR.expressions.MonthOfYearExpression,	'now'	:	SUGAR.expressions.NowExpression,	'timestamp'	:	SUGAR.expressions.TimestampExpression,	'strToUpper'	:	SUGAR.expressions.StrToUpperExpression,	'toString'	:	SUGAR.expressions.DefineStringExpression,	'string'	:	SUGAR.expressions.DefineStringExpression,	'getDropdownValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'getDDValue'	:	SUGAR.expressions.SugarDropDownValueExpression,	'charAt'	:	SUGAR.expressions.CharacterAtExpression,	'concat'	:	SUGAR.expressions.ConcatenateExpression,	'strToLower'	:	SUGAR.expressions.StrToLowerExpression,	'contains'	:	SUGAR.expressions.ContainsExpression,	'formatName'	:	SUGAR.expressions.FormatedNameExpression,	'subStr'	:	SUGAR.expressions.SubStrExpression,	'translateLabel'	:	SUGAR.expressions.SugarTranslateExpression,	'translate'	:	SUGAR.expressions.SugarTranslateExpression,	'forecastCommitStage'	:	SUGAR.expressions.ForecastCommitStageExpression};
/**
 * The function to object map that is used by the Parser
 * to parse expressions into objects.
 */
